        ...
        <Box>
            ...
            {showBody &&
                <Body>
                    ...
                    <List>
                        <Item onClick={() => alert('Você clicou em um item 😄')} title='Go to transactions'>
                            <Icon icon="mingcute:transfer-line" width={20} color="#D0D0D0" />
                            Transactions
                        </Item>
                        <Item onClick={() => alert('Você clicou em um item 😄')} title='Go to inventory'>
                            <Icon icon="akar-icons:shipping-box-01" width={20} color="#D0D0D0" />
                            Inventory
                        </Item>
                        <Item onClick={() => alert('Você clicou em um item 😄')} title='Go to shop'>
                            <Icon icon="akar-icons:shopping-bag" width={20} color="#D0D0D0" />
                            Shop
                        </Item>
                        <Item onClick={() => alert('Você clicou em um item 😄')} title='Logout'>
